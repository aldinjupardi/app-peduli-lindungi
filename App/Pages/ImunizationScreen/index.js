...
import {ic_check_in, ic_child, ic_covid} from "../../assets";
         ...
         <View style={styles.bgApp}>
            <View style={styles.item}>
                <View style={{flexDirection: 'row'}}>
                    ...
                    <Image source={ic_covid} style={styles.gambar1}/>
...
/>
                ...
                <View style={{flexDirection: 'row'}}>
                    <Image source={ic_check_in} style={styles.gambar2}/>
                        <View style={{flexDirection: 'column'}}>
...
/>
                 <View style={{flexDirection: 'row'}}>
                    <Image source={ic_child} style={styles.gambar2}/>
                        <View style={{flexDirection: 'column'}}>
