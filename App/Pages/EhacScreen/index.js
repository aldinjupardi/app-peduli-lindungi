...
import {BG_EHC,ic_create_ehc,ic_my_ehc} from "../../assets";
    ...
    return (
        <View style={styles.bgApp}>
            ...
            <View>
                ...
                <Image source={BG_EHC} style={styles.gambartop} />
            </View>

            <View style={styles.item}>
                <View style={{flexDirection: 'row'}}>
                    <Image source={ic_my_ehc} style={styles.gambar1}/>
...
/>
                <View style={{flexDirection: 'row'}}>
                    <Image source={ic_create_ehc} style={styles.gambar2}/>
                        <View style={{flexDirection: 'column'}}>
